...
pot = int(input("Entre un premier nombre"))
co = int(input("Un deuxième maintenant"))
lo = pot + co
print("Leur somme est",lo)
mo = pot - co
print("Leur différence est",mo)
lolo = pot*co
print("Leur produit est",lolo)
```

    Entre un premier nombre12
    Un deuxième maintenant15
    Leur somme est 27
